...
public class ExcelService {
	...
	private String classroomToString(LessonModel lesson) {
		if (lesson.getRoom().getSourceId() == 156)
			return "Б с/з";
		if (lesson.getRoom().getSourceId() == 157)
			return "СК";
		if (lesson.getRoom().getSourceId() == 158)
			return "М с/з";
		if (lesson.getRoom().getSourceId() == 172)
			return "";
	...
	private String classroomToString(ClassroomModel classroomModel) {
		if (classroomModel.getSourceId() == 156)
			return "Б с/з";
		if (classroomModel.getSourceId() == 157)
			return "СК";
		if (classroomModel.getSourceId() == 158)
			return "М с/з";
		if (classroomModel.getSourceId() == 172)
			return "";
