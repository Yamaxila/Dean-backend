...
(
    ...
    status    INTEGER,
    name      VARCHAR(255),
    CONSTRAINT pk_foreigner PRIMARY KEY (id)
);
...
ALTER TABLE documents
    ADD CONSTRAINT FK_DOCUMENTS_ON_FOREIGNER FOREIGN KEY (foreigner) REFERENCES foreigner (id);
